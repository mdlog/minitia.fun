...
export function MobileDock() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-3 z-50 px-3 lg:hidden">
      <nav className="pointer-events-auto mx-auto grid max-w-3xl grid-cols-5 gap-1 rounded-[24px] glass px-2 py-2 ghost-border shadow-ambient">
        {primaryNav.map((item) => {
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active
                  ? "bg-white/[0.08] text-on-surface shadow-[0_16px_32px_rgba(0,0,0,0.24)]"
